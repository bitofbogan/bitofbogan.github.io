...
const questionBank = [
  {
    ...
    image: null,
    hint: "Piensa en el modelo de investigación científica que surgió tras la Segunda Guerra Mundial y opera con macroequipos multidisciplinarios.",
    correct: "Gran Ciencia.",
    distractors: [
      "Pequeña Ciencia.",
      "Tecnociencia."
    ],
    explanation: "La Gran Ciencia se define por proyectos a gran escala y presupuestos significativos donde colaboran equipos interdisciplinarios, difundiendo sus hallazgos en publicaciones y congresos internacionales."
  },
  {
    id: 2,
    type: "choice",
    ...
    image: null,
    hint: "Identifica los canales de divulgación académica y abierta frente a las herramientas de registro mercantil o comercial.",
    ...
    explanation: "Al tratarse de proyectos financiados en su mayoría con fondos públicos para el avance del conocimiento básico, sus resultados se socializan mediante conferencias, congresos y artículos arbitrados, no por patentes comerciales."
  },
  {
    id: 3,
    type: "choice",
    ...
    image: null,
    hint: "Se enfoca en descifrar el manual biológico completo de la especie humana sin limitarse a anomalías.",
    ...
    explanation: "El Proyecto Genoma Humano secuenció los más de tres mil millones de pares de bases nitrogenadas del ADN para identificar la posición cromosómica, estructura química y función de cada gen."
  },
  {
    id: 4,
    type: "choice",
    ...
    image: null,
    hint: "Es la categoría de la ciencia orientada a resolver problemas concretos y producir artefactos o procesos útiles.",
    correct: "Aplicada",
    distractors: [
      "Técnica",
      "Tecnológica",
  ...
  },
  {
    ...
    explanation: "El efecto invernadero es un proceso biofísico donde gases como el $CO_2$ y el vapor de agua atrapan la radiación infrarroja emitida por la superficie del planeta tras ser calentada por el Sol, evitando que escape al espacio exterior[cite: 2]."
  },
  {
    id: 6,
    type: "multi_select",
    ...
    image: null,
    hint: "Distingue entre los beneficios agropecuarios comprobados y los escenarios donde hay incertidumbre toxicológica o ambiental.",
    correctAnswers: [
    ...
    explanation: "El peligro real de los organismos modificados genéticamente radica en la falta de ensayos sobre toxicidad, el riesgo de alergias imprevistas y alteraciones en los ciclos de degradación biológica[cite: 2]."
  },
  {
    id: 7,
    type: "classification",
    ...
    items: [
      { text: "Utiliza gas natural que es ecológico y barato.", correct: "Tradicional" },
      { text: "Para cocinar utiliza gas LP que es no renovable.", correct: "Tradicional" },
      { text: "Purifica el agua usada para poder utilizarla varias veces.", correct: "Autosustentable" },
      { text: "Utiliza el agua usada para riego de un jardín u hortaliza casera.", correct: "Autosustentable" },
      { text: "Regula la temperatura con materiales aislantes o con celdas solares.", correct: "Autosustentable" },
      { text: "Calienta el agua con un calentador solar de tuberías y depósito aislado.", correct: "Autosustentable" }
    ],
    explanation: "El gas natural y el LP provienen de hidrocarburos no renovables (tradicionales). El reciclaje de aguas residuales, el aislamiento térmico y el aprovechamiento solar directo son prácticas autosustentables[cite: 2]."
  },
  {
    id: 8,
    type: "multi_select",
    ...
    image: null,
    hint: "Considera los gases liberados tanto por la respiración como por la fermentación entérica en el ganado rumiante.",
    correctAnswers: [
      "Dióxido de carbono.",
      "Metano."
    ],
    ...
    explanation: "La ganadería produce metano ($CH_4$) por la fermentación digestiva y manejo de estiércol, además de dióxido de carbono ($CO_2$) por respiración y transporte asociado[cite: 2]. El monóxido de carbono proviene de combustiones incompletas en motores[cite: 2]."
  },
  {
    id: 9,
    type: "multi_select",
    ...
    image: null,
    hint: "Enfócate en los gases derivados de la quema completa e incompleta de combustibles derivados del petróleo.",
    correctAnswers: [
      "Dióxido de carbono.",
      "Monóxido de carbono."
    ],
    ...
    explanation: "La quema de gasolina en motores vehiculares libera dióxido de carbono ($CO_2$) por combustión y monóxido de carbono ($CO$) debido a la combustión incompleta de los hidrocarburos[cite: 2]."
  },
  {
    id: 10,
    type: "choice",
    ...
    image: null,
    hint: "Señala el debate prioritario en bioética y salud pública sobre el consumo de OGM.",
    ...
    explanation: "La mayor controversia social y regulatoria gira en torno a la bioseguridad y a evaluar si el consumo prolongado de transgénicos genera efectos adversos o alergias en la salud humana[cite: 2]."
  },
  {
    id: 11,
    type: "choice",
    ...
    explanation: "Una patente protege invenciones o desarrollos tecnológicos aplicados frente a apropiaciones indebidas[cite: 2]. Los descubrimientos de la ciencia básica o las leyes naturales no son susceptibles de patentarse[cite: 2]."
  },
  {
    id: 12,
    type: "choice",
    ...
    explanation: "La energía nuclear es aquella almacenada en el núcleo atómico y liberada mediante procesos nucleares (fisión o fusión), a diferencia de las reacciones químicas que involucran enlaces entre electrones[cite: 2]."
  },
  {
    id: 13,
    type: "choice",
    ...
    image: null,
    hint: "El término 'fisión' proviene de dividir o escindir.",
    ...
    explanation: "La fisión nuclear consiste en fragmentar el núcleo de un átomo pesado e inestable (como el uranio-235) al ser bombardeado por neutrones, liberando gran cantidad de calor[cite: 2]."
  },
  {
    id: 14,
    type: "choice",
    ...
    explanation: "En la fusión nuclear dos núcleos ligeros (isótopos de hidrógeno como deuterio y tritio) se combinan a temperaturas y presiones extremas para formar un núcleo más pesado (helio)[cite: 2]."
  },
  {
    id: 15,
    type: "choice",
    ...
    explanation: "La medicina genómica aplica la secuenciación del ADN para identificar mutaciones patológicas, evaluar predisposiciones genéticas y diseñar intervenciones terapéuticas preventivas[cite: 2]."
  },
  {
    id: 16,
    type: "choice",
    ...
    explanation: "El propósito de la ciencia radica en expandir el conocimiento humano y comprender los fenómenos naturales sin perseguir obligatoriamente un fin utilitario inmediato[cite: 2]."
  },
  {
    id: 17,
    type: "choice",
    ...
    explanation: "La tecnología toma los principios científicos para desarrollar técnicas, herramientas y procesos dirigidos a modificar el entorno material y la vida humana[cite: 2]."
  },
  {
    id: 18,
    type: "choice",
    ...
    explanation: "El Proyecto Manhattan fue el plan estratégico coordinado en Los Álamos para diseñar y detonar los primeros artefactos atómicos durante la Segunda Guerra Mundial[cite: 2]."
  },
  {
    id: 19,
    type: "choice",
    ...
    image: null,
    hint: "Describe la integración indivisible entre ciencia teórica, ingeniería avanzada e intereses militares e industriales.",
    correct: "Tecnociencia.",
    distractors: [
      "Gran Ciencia.",
      "Pequeña Ciencia."
    ],
    explanation: "El Proyecto Manhattan es el paradigma fundacional de la tecnociencia: borró la frontera entre la investigación fundamental y el diseño bélico-industrial coordinado por el Estado[cite: 2]."
  },
  {
    id: 20,
    type: "choice",
    ...
    explanation: "Las leyes físicas son formulaciones teóricas neutrales, mientras que la producción de organismos modificados genéticamente involucra debates sobre bioseguridad, patentes alimentarias y soberanía sanitaria[cite: 2]."
  },
  {
    id: 21,
    type: "choice",
    ...
    explanation: "La persistencia de la brecha digital y la disparidad socioeconómica impiden que la red garantice justicia social si amplios sectores carecen de acceso libre y equitativo[cite: 2]."
  },
  {
    id: 22,
    type: "choice",
    ...
    explanation: "Los neutrones son hadrones no elementales constituidos internamente por tres quarks (un quark up y dos quarks down) unidos mediante gluones por la fuerza nuclear fuerte[cite: 2]."
  },
  {
    id: 23,
    type: "choice",
    ...
    explanation: "La responsabilidad social empresarial implica evaluar el ciclo integral del negocio para mitigar daños ambientales o laborales e impulsar activamente beneficios para la sociedad[cite: 2]."
  },
  {
    id: 24,
    type: "choice",
    ...
    image: null,
    hint: "Es el método nuclear comercial que fractura núcleos pesados de uranio enriquecido.",
    ...
    explanation: "Laguna Verde opera reactores de agua en ebullición basados en la fisión controlada de uranio enriquecido para producir vapor y mover turbinas generadoras[cite: 2]."
  },
  {
    id: 25,
    type: "choice",
    ...
    image: null,
    hint: "Corresponde al reactor japonés involucrado en el accidente de marzo de 2011.",
    correct: "Fukushima.",
    distractors: [
      "Chernobyl.",
      "Tokamak.",
    ...
    explanation: "Tanto Laguna Verde como las unidades accidentadas en Fukushima Daiichi corresponden a reactores comerciales de fisión nuclear de tecnología occidental[cite: 2]."
  },
  {
    id: 26,
    type: "choice",
    ...
    explanation: "Los foros de tareas abiertos y chats sin moderación carecen de arbitraje científico, validación de fuentes y rigor metodológico[cite: 2]."
  },
  {
    id: 27,
    type: "choice",
    ...
    image: null,
    hint: "Fue construido en el CERN para poner a prueba el Modelo Estándar de la materia elemental.",
    ...
    explanation: "El LHC hace chocar haces de protones a velocidades cercanas a la de la luz para recrear condiciones primordiales y validar las partículas predichas por el Modelo Estándar[cite: 2]."
  },
  {
    id: 28,
    type: "multi_select",
    ...
    explanation: "La difusión científica en medios prioriza el reporte de experimentos en ciencias fundamentales, el rigor metodológico institucional y la innovación de frontera en telecomunicaciones y cómputo[cite: 2]."
  },
  {
    id: 29,
    type: "choice",
    ...
    explanation: "Las fuentes renovables (como la energía solar, eólica o geotérmica) dependen de ciclos biofísicos perpetuos que no se agotan con el aprovechamiento humano[cite: 2]."
  },
  {
    id: 30,
    type: "choice",
    ...
    image: null,
    hint: "Enfoca la solución ambiental como una responsabilidad ciudadana y moral compartida.",
    ...
    explanation: "La ética ambiental plantea que la preservación de los ecosistemas no es un asunto exclusivo de especialistas, sino un deber colectivo que exige conciencia social cotidiana[cite: 2]."
  },
  {
    id: 31,
    type: "choice",
    ...
    explanation: "Según la postura de Roberto Balaguer, si la ciberadicción se clasifica formalmente como patología en manuales psiquiátricos, adquiere reconocimiento laboral y legal vinculante[cite: 3]."
  },
  {
    id: 32,
    type: "multi_select",
    ...
    image: null,
    hint: "Busca los principios epistemológicos sobre regularidades empíricas y refutabilidad por experimentación.",
    correctAnswers: [
    ...
    explanation: "La ciencia es objetiva y falsable: observa regularidades en la naturaleza y somete sus explicaciones a contrastación empírica, sin depender de opiniones populares o dogmas estáticos[cite: 2]."
  },
  {
    id: 33,
    type: "choice",
    ...
    image: null,
    hint: "Recuerda la palabra que alude a fundir o unir elementos.",
    correct: "Fusión.",
    distractors: [
      "Energía.",
      "Fisión.",
    ...
    explanation: "La fusión nuclear es el proceso físico en el que dos núcleos atómicos se integran para dar origen a un nuevo elemento de mayor masa[cite: 2]."
  },
  {
    id: 34,
    type: "choice",
    ...
    image: null,
    hint: "Si dos núcleos ligeros se suman, la masa resultante de la partícula producto es mayor.",
    correct: "Más.",
    distractors: [
      "Menos."
    ],
    explanation: "Al integrarse dos núcleos ligeros, la masa atómica resultante es mayor que la de los componentes individuales de partida[cite: 2]."
  },
  {
    id: 35,
    type: "choice",
    ...
    explanation: "Los isótopos de hidrógeno (deuterio y tritio) son los candidatos preferidos para la fusión debido a su ligereza y a la energía que liberan al fusionarse en helio[cite: 2]."
  }
];
